...
#define BLYNK_TEMPLATE_ID "TMPLZ4RV5Er7"
#define BLYNK_DEVICE_NAME "testproject"
#define BLYNK_AUTH_TOKEN "dxUctTMeYWnf0HFaibqSDClWp42z5cbS"
...
const int MQ_PIN=2;                                //define which analog input channel you are going to use
...
void senddatamq2(){
  Data_PPM_Smoke = "Data Smoke = " + String(iPPM_Smoke) + "PPM";
  bot.sendMessage(CHAT_ID, Data_PPM_Smoke); 
  }
